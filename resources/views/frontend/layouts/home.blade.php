	...
	<section class="mission_vision">
		<div class="container">
			...
			<div class="row">
				...
				<p style="text-align: justify;"><strong>Mission</strong>{{$missions->title}}</p>
				</div>
				<div class="col-md-6">
					<img src="{{asset('upload/vision_images/'.$visions->image)}}" style="border: 1px solid #ddd;padding: 5px;background: #EFEE03;border-radius: 30px;float: left;margin-right: 10px;">
				<p style="text-align: justify;"><strong>Vision</strong>{{$visions->title}}</p>
				</div>
			</div>
		</div>
	</section>
